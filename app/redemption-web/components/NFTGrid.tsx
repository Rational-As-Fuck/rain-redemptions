...
import { NFT, DTP_TYPE, redeemPanda } from '../lib/nft';
...
type NFTGridProps = { program: IMSOClaim, loading: boolean, nfts: NFT[], hasRainATA: boolean };
