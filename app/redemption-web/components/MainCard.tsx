    ...
    <div className="max-w-sm pb-5">
      <Card href="#">
        <h5 className="font-display text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
          Welcome to Degen Trash Pandas RAIN Redemption
        </h5>
        <p className="text-sm font-display text-gray-700 dark:text-gray-400">
          Connect the wallet that holds your Pandas.
        </p>
        <div className="m-auto"><WalletMultiButton /></div>
        <Link href='/redemptionChecker'>
          <a href="#" className="text-sm font-display inline-flex items-center text-blue-600 hover:underline">
            Check your Panda Redemtion status here
